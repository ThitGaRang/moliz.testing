...
* generated by Xtext
*/
package org.modelexecution.fumltesting.xmof.ui.contentassist.antlr;
...
public class XmofTestLangParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.modelexecution.fumltesting.xmof.ui.contentassist.antlr.internal.InternalXmofTestLangParser createParser() {
		org.modelexecution.fumltesting.xmof.ui.contentassist.antlr.internal.InternalXmofTestLangParser result = new org.modelexecution.fumltesting.xmof.ui.contentassist.antlr.internal.InternalXmofTestLangParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getXMOFValueAccess().getAlternatives(), "rule__XMOFValue__Alternatives");
					put(grammarAccess.getXMOFAssertionAccess().getAlternatives(), "rule__XMOFAssertion__Alternatives");
					put(grammarAccess.getXMOFReferencePointAccess().getAlternatives(), "rule__XMOFReferencePoint__Alternatives");
					put(grammarAccess.getXMOFCheckAccess().getAlternatives(), "rule__XMOFCheck__Alternatives");
					put(grammarAccess.getXMOFStateExpressionAccess().getAlternatives(), "rule__XMOFStateExpression__Alternatives");
					put(grammarAccess.getXMOFNodeSpecificationAccess().getAlternatives(), "rule__XMOFNodeSpecification__Alternatives");
					...
					put(grammarAccess.getXMOFArithmeticOperatorAccess().getAlternatives(), "rule__XMOFArithmeticOperator__Alternatives");
					put(grammarAccess.getXMOFTemporalOperatorAccess().getAlternatives(), "rule__XMOFTemporalOperator__Alternatives");
					put(grammarAccess.getXMOFTemporalQuantifierAccess().getAlternatives(), "rule__XMOFTemporalQuantifier__Alternatives");
					put(grammarAccess.getXMOFTestSuiteAccess().getGroup(), "rule__XMOFTestSuite__Group__0");
					put(grammarAccess.getImportAccess().getGroup(), "rule__Import__Group__0");
					put(grammarAccess.getXMOFTestCaseAccess().getGroup(), "rule__XMOFTestCase__Group__0");
					put(grammarAccess.getXMOFTestCaseAccess().getGroup_4(), "rule__XMOFTestCase__Group_4__0");
					put(grammarAccess.getXMOFTestCaseAccess().getGroup_4_2(), "rule__XMOFTestCase__Group_4_2__0");
					put(grammarAccess.getXMOFTestCaseAccess().getGroup_5(), "rule__XMOFTestCase__Group_5__0");
					put(grammarAccess.getXMOFTestCaseAccess().getGroup_7(), "rule__XMOFTestCase__Group_7__0");
					put(grammarAccess.getXMOFTestCaseAccess().getGroup_7_3(), "rule__XMOFTestCase__Group_7_3__0");
					put(grammarAccess.getXMOFActivityInputAccess().getGroup(), "rule__XMOFActivityInput__Group__0");
					put(grammarAccess.getXMOFScenarioAccess().getGroup(), "rule__XMOFScenario__Group__0");
					put(grammarAccess.getXMOFObjectSpecificationAccess().getGroup(), "rule__XMOFObjectSpecification__Group__0");
					put(grammarAccess.getXMOFAttributeAccess().getGroup(), "rule__XMOFAttribute__Group__0");
					put(grammarAccess.getXMOFLinkAccess().getGroup(), "rule__XMOFLink__Group__0");
					put(grammarAccess.getXMOFStateAssertionAccess().getGroup(), "rule__XMOFStateAssertion__Group__0");
					put(grammarAccess.getXMOFStateAssertionAccess().getGroup_4(), "rule__XMOFStateAssertion__Group_4__0");
					put(grammarAccess.getXMOFActionReferencePointAccess().getGroup(), "rule__XMOFActionReferencePoint__Group__0");
					put(grammarAccess.getXMOFConstraintReferencePointAccess().getGroup(), "rule__XMOFConstraintReferencePoint__Group__0");
					put(grammarAccess.getXMOFFinallyStateAssertionAccess().getGroup(), "rule__XMOFFinallyStateAssertion__Group__0");
					put(grammarAccess.getXMOFConstraintCheckAccess().getGroup(), "rule__XMOFConstraintCheck__Group__0");
					put(grammarAccess.getXMOFConstraintCheckAccess().getGroup_2(), "rule__XMOFConstraintCheck__Group_2__0");
					put(grammarAccess.getXMOFConstraintCheckAccess().getGroup_3(), "rule__XMOFConstraintCheck__Group_3__0");
					put(grammarAccess.getXMOFObjectStateExpressionAccess().getGroup(), "rule__XMOFObjectStateExpression__Group__0");
					put(grammarAccess.getXMOFPropertyStateExpressionAccess().getGroup(), "rule__XMOFPropertyStateExpression__Group__0");
					put(grammarAccess.getXMOFOrderAssertionAccess().getGroup(), "rule__XMOFOrderAssertion__Group__0");
					put(grammarAccess.getXMOFNodeOrderAccess().getGroup(), "rule__XMOFNodeOrder__Group__0");
					put(grammarAccess.getXMOFNodeOrderAccess().getGroup_1(), "rule__XMOFNodeOrder__Group_1__0");
					put(grammarAccess.getXMOFNodeSpecificationAccess().getGroup_0(), "rule__XMOFNodeSpecification__Group_0__0");
					put(grammarAccess.getXMOFNodeSpecificationAccess().getGroup_0_1(), "rule__XMOFNodeSpecification__Group_0_1__0");
					put(grammarAccess.getXMOFNodeSpecificationAccess().getGroup_0_2(), "rule__XMOFNodeSpecification__Group_0_2__0");
					...
					put(grammarAccess.getXMOFTestSuiteAccess().getImportsAssignment_0(), "rule__XMOFTestSuite__ImportsAssignment_0");
					put(grammarAccess.getXMOFTestSuiteAccess().getScenariosAssignment_1(), "rule__XMOFTestSuite__ScenariosAssignment_1");
					put(grammarAccess.getXMOFTestSuiteAccess().getTestsAssignment_2(), "rule__XMOFTestSuite__TestsAssignment_2");
					put(grammarAccess.getImportAccess().getImportedNamespaceAssignment_1(), "rule__Import__ImportedNamespaceAssignment_1");
					put(grammarAccess.getXMOFTestCaseAccess().getNameAssignment_1(), "rule__XMOFTestCase__NameAssignment_1");
					put(grammarAccess.getXMOFTestCaseAccess().getActivityUnderTestAssignment_3(), "rule__XMOFTestCase__ActivityUnderTestAssignment_3");
					put(grammarAccess.getXMOFTestCaseAccess().getInputsAssignment_4_1(), "rule__XMOFTestCase__InputsAssignment_4_1");
					put(grammarAccess.getXMOFTestCaseAccess().getInputsAssignment_4_2_1(), "rule__XMOFTestCase__InputsAssignment_4_2_1");
					put(grammarAccess.getXMOFTestCaseAccess().getContextObjectAssignment_5_1(), "rule__XMOFTestCase__ContextObjectAssignment_5_1");
					put(grammarAccess.getXMOFTestCaseAccess().getInitScenariosAssignment_7_2(), "rule__XMOFTestCase__InitScenariosAssignment_7_2");
					put(grammarAccess.getXMOFTestCaseAccess().getInitScenariosAssignment_7_3_1(), "rule__XMOFTestCase__InitScenariosAssignment_7_3_1");
					put(grammarAccess.getXMOFTestCaseAccess().getAssertionsAssignment_8(), "rule__XMOFTestCase__AssertionsAssignment_8");
					put(grammarAccess.getXMOFActivityInputAccess().getParameterAssignment_0(), "rule__XMOFActivityInput__ParameterAssignment_0");
					put(grammarAccess.getXMOFActivityInputAccess().getValueAssignment_2(), "rule__XMOFActivityInput__ValueAssignment_2");
					put(grammarAccess.getXMOFSimpleValueAccess().getValueAssignment(), "rule__XMOFSimpleValue__ValueAssignment");
					put(grammarAccess.getXMOFObjectValueAccess().getValueAssignment(), "rule__XMOFObjectValue__ValueAssignment");
					put(grammarAccess.getXMOFScenarioAccess().getNameAssignment_1(), "rule__XMOFScenario__NameAssignment_1");
					put(grammarAccess.getXMOFScenarioAccess().getObjectsAssignment_3(), "rule__XMOFScenario__ObjectsAssignment_3");
					put(grammarAccess.getXMOFScenarioAccess().getLinksAssignment_4(), "rule__XMOFScenario__LinksAssignment_4");
					put(grammarAccess.getXMOFObjectSpecificationAccess().getNameAssignment_1(), "rule__XMOFObjectSpecification__NameAssignment_1");
					put(grammarAccess.getXMOFObjectSpecificationAccess().getTypeAssignment_3(), "rule__XMOFObjectSpecification__TypeAssignment_3");
					put(grammarAccess.getXMOFObjectSpecificationAccess().getAttributesAssignment_5(), "rule__XMOFObjectSpecification__AttributesAssignment_5");
					put(grammarAccess.getXMOFAttributeAccess().getAttAssignment_0(), "rule__XMOFAttribute__AttAssignment_0");
					put(grammarAccess.getXMOFAttributeAccess().getValueAssignment_2(), "rule__XMOFAttribute__ValueAssignment_2");
					put(grammarAccess.getXMOFLinkAccess().getAssocAssignment_1(), "rule__XMOFLink__AssocAssignment_1");
					put(grammarAccess.getXMOFLinkAccess().getSourcePropertyAssignment_4(), "rule__XMOFLink__SourcePropertyAssignment_4");
					put(grammarAccess.getXMOFLinkAccess().getSourceValueAssignment_6(), "rule__XMOFLink__SourceValueAssignment_6");
					put(grammarAccess.getXMOFLinkAccess().getTargetPropertyAssignment_9(), "rule__XMOFLink__TargetPropertyAssignment_9");
					put(grammarAccess.getXMOFLinkAccess().getTargetValueAssignment_11(), "rule__XMOFLink__TargetValueAssignment_11");
					put(grammarAccess.getXMOFStateAssertionAccess().getQuantifierAssignment_1(), "rule__XMOFStateAssertion__QuantifierAssignment_1");
					put(grammarAccess.getXMOFStateAssertionAccess().getOperatorAssignment_2(), "rule__XMOFStateAssertion__OperatorAssignment_2");
					put(grammarAccess.getXMOFStateAssertionAccess().getReferencePointAssignment_3(), "rule__XMOFStateAssertion__ReferencePointAssignment_3");
					put(grammarAccess.getXMOFStateAssertionAccess().getUntilPointAssignment_4_1(), "rule__XMOFStateAssertion__UntilPointAssignment_4_1");
					put(grammarAccess.getXMOFStateAssertionAccess().getChecksAssignment_6(), "rule__XMOFStateAssertion__ChecksAssignment_6");
					put(grammarAccess.getXMOFActionReferencePointAccess().getActionAssignment_1(), "rule__XMOFActionReferencePoint__ActionAssignment_1");
					put(grammarAccess.getXMOFConstraintReferencePointAccess().getConstraintNameAssignment_1(), "rule__XMOFConstraintReferencePoint__ConstraintNameAssignment_1");
					put(grammarAccess.getXMOFFinallyStateAssertionAccess().getChecksAssignment_3(), "rule__XMOFFinallyStateAssertion__ChecksAssignment_3");
					put(grammarAccess.getXMOFConstraintCheckAccess().getConstraintNamesAssignment_1(), "rule__XMOFConstraintCheck__ConstraintNamesAssignment_1");
					put(grammarAccess.getXMOFConstraintCheckAccess().getConstraintNamesAssignment_2_1(), "rule__XMOFConstraintCheck__ConstraintNamesAssignment_2_1");
					put(grammarAccess.getXMOFConstraintCheckAccess().getObjectAssignment_3_1(), "rule__XMOFConstraintCheck__ObjectAssignment_3_1");
					put(grammarAccess.getXMOFObjectStateExpressionAccess().getPinAssignment_0(), "rule__XMOFObjectStateExpression__PinAssignment_0");
					put(grammarAccess.getXMOFObjectStateExpressionAccess().getOperatorAssignment_1(), "rule__XMOFObjectStateExpression__OperatorAssignment_1");
					put(grammarAccess.getXMOFObjectStateExpressionAccess().getValueAssignment_2(), "rule__XMOFObjectStateExpression__ValueAssignment_2");
					put(grammarAccess.getXMOFPropertyStateExpressionAccess().getPinAssignment_0(), "rule__XMOFPropertyStateExpression__PinAssignment_0");
					put(grammarAccess.getXMOFPropertyStateExpressionAccess().getPropertyAssignment_2(), "rule__XMOFPropertyStateExpression__PropertyAssignment_2");
					put(grammarAccess.getXMOFPropertyStateExpressionAccess().getOperatorAssignment_3(), "rule__XMOFPropertyStateExpression__OperatorAssignment_3");
					put(grammarAccess.getXMOFPropertyStateExpressionAccess().getValueAssignment_4(), "rule__XMOFPropertyStateExpression__ValueAssignment_4");
					put(grammarAccess.getXMOFOrderAssertionAccess().getOrderAssignment_1(), "rule__XMOFOrderAssertion__OrderAssignment_1");
					put(grammarAccess.getXMOFNodeOrderAccess().getNodesAssignment_0(), "rule__XMOFNodeOrder__NodesAssignment_0");
					put(grammarAccess.getXMOFNodeOrderAccess().getNodesAssignment_1_1(), "rule__XMOFNodeOrder__NodesAssignment_1_1");
					put(grammarAccess.getXMOFNodeSpecificationAccess().getNodeAssignment_0_0(), "rule__XMOFNodeSpecification__NodeAssignment_0_0");
					put(grammarAccess.getXMOFNodeSpecificationAccess().getSizeAssignment_0_1_1(), "rule__XMOFNodeSpecification__SizeAssignment_0_1_1");
					put(grammarAccess.getXMOFNodeSpecificationAccess().getSubOrderAssignment_0_2_1(), "rule__XMOFNodeSpecification__SubOrderAssignment_0_2_1");
					put(grammarAccess.getXMOFNodeSpecificationAccess().getJokerAssignment_1(), "rule__XMOFNodeSpecification__JokerAssignment_1");
					put(grammarAccess.getXMOFNodeSpecificationAccess().getJokerAssignment_2(), "rule__XMOFNodeSpecification__JokerAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.modelexecution.fumltesting.xmof.ui.contentassist.antlr.internal.InternalXmofTestLangParser typedParser = (org.modelexecution.fumltesting.xmof.ui.contentassist.antlr.internal.InternalXmofTestLangParser) parser;
			typedParser.entryRuleXMOFTestSuite();
