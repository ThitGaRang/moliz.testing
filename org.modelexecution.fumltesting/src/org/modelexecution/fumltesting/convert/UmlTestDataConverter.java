...
public class UmlTestDataConverter implements TestDataConverter {
	...
	public UmlTestDataConverter(ModelConverter modelConverter) {
	...
	@Override
	public Object getFUMLElement(Object value) {
