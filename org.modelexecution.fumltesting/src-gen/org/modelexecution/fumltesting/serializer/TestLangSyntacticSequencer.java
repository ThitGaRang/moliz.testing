...
public class TestLangSyntacticSequencer extends AbstractSyntacticSequencer {

	protected TestLangGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (TestLangGrammarAccess) access;
