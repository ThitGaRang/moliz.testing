...
public class TestLangAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected TestLangSwitch<Adapter> modelSwitch =
    new TestLangSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseOCLInvariants(OCLInvariants object)
      {
        return createOCLInvariantsAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.modelexecution.fumltesting.testLang.OCLInvariants <em>OCL Invariants</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createOCLInvariantsAdapter()
  {
    return null;
  }
