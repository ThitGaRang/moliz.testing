 ...
 * <ul>
 *   <li>{@link org.modelexecution.fumltesting.testLang.impl.UMLOrderAssertionImpl#getOrder <em>Order</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UMLOrderAssertionImpl extends UMLAssertionImpl implements UMLOrderAssertion
{
  ...
  {
    return TestLangPackage.Literals.UML_ORDER_ASSERTION;
  }
  ...
  public NotificationChain basicSetOrder(UMLNodeOrder newOrder, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TestLangPackage.UML_ORDER_ASSERTION__ORDER, oldOrder, newOrder);
  ...
  public void setOrder(UMLNodeOrder newOrder)
  {
    if (newOrder != order)
    {
      ...
      if (order != null)
        msgs = ((InternalEObject)order).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TestLangPackage.UML_ORDER_ASSERTION__ORDER, null, msgs);
      if (newOrder != null)
        msgs = ((InternalEObject)newOrder).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TestLangPackage.UML_ORDER_ASSERTION__ORDER, null, msgs);
      msgs = basicSetOrder(newOrder, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TestLangPackage.UML_ORDER_ASSERTION__ORDER, newOrder, newOrder));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TestLangPackage.UML_ORDER_ASSERTION__ORDER:
