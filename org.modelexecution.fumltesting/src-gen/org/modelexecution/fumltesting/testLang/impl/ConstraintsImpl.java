 ...
 * <ul>
 *   <li>{@link org.modelexecution.fumltesting.testLang.impl.ConstraintsImpl#getNames <em>Names</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConstraintsImpl extends MinimalEObjectImpl.Container implements Constraints
{
   ...
   * @ordered
   */
  protected EList<XExpression> names;
  ...
  {
    return TestLangPackage.Literals.CONSTRAINTS;
  }
   ...
   * @generated
   */
  public EList<XExpression> getNames()
  {
    if (names == null)
    {
      names = new EObjectContainmentEList<XExpression>(XExpression.class, this, TestLangPackage.CONSTRAINTS__NAMES);
    }
    return names;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TestLangPackage.CONSTRAINTS__NAMES:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case TestLangPackage.CONSTRAINTS__NAMES:
        getNames().clear();
        getNames().addAll((Collection<? extends XExpression>)newValue);
        return;
    }
