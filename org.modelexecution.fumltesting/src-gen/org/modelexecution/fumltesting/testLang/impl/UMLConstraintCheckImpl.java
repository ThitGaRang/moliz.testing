 ...
 * <ul>
 *   <li>{@link org.modelexecution.fumltesting.testLang.impl.UMLConstraintCheckImpl#getConstraintNames <em>Constraint Names</em>}</li>
 *   <li>{@link org.modelexecution.fumltesting.testLang.impl.UMLConstraintCheckImpl#getObject <em>Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UMLConstraintCheckImpl extends UMLCheckImpl implements UMLConstraintCheck
{
  ...
  {
    return TestLangPackage.Literals.UML_CONSTRAINT_CHECK;
  }
  ...
  public EList<XExpression> getConstraintNames()
  {
    ...
    {
      constraintNames = new EObjectContainmentEList<XExpression>(XExpression.class, this, TestLangPackage.UML_CONSTRAINT_CHECK__CONSTRAINT_NAMES);
    }
    ...
    if (object != null && object.eIsProxy())
    {
      ...
      if (object != oldObject)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, TestLangPackage.UML_CONSTRAINT_CHECK__OBJECT, oldObject, object));
      }
    }
    return object;
  }
  ...
  public void setObject(ObjectNode newObject)
  {
    ...
    object = newObject;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TestLangPackage.UML_CONSTRAINT_CHECK__OBJECT, oldObject, object));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TestLangPackage.UML_CONSTRAINT_CHECK__CONSTRAINT_NAMES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case TestLangPackage.UML_CONSTRAINT_CHECK__OBJECT:
