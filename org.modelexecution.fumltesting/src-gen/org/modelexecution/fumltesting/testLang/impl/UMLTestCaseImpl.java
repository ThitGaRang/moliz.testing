 ...
 * <ul>
 *   <li>{@link org.modelexecution.fumltesting.testLang.impl.UMLTestCaseImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.modelexecution.fumltesting.testLang.impl.UMLTestCaseImpl#getActivityUnderTest <em>Activity Under Test</em>}</li>
 *   <li>{@link org.modelexecution.fumltesting.testLang.impl.UMLTestCaseImpl#getInputs <em>Inputs</em>}</li>
 *   <li>{@link org.modelexecution.fumltesting.testLang.impl.UMLTestCaseImpl#getContextObject <em>Context Object</em>}</li>
 *   <li>{@link org.modelexecution.fumltesting.testLang.impl.UMLTestCaseImpl#getInitScenarios <em>Init Scenarios</em>}</li>
 *   <li>{@link org.modelexecution.fumltesting.testLang.impl.UMLTestCaseImpl#getAssertions <em>Assertions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UMLTestCaseImpl extends MinimalEObjectImpl.Container implements UMLTestCase
{
  ...
  {
    return TestLangPackage.Literals.UML_TEST_CASE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TestLangPackage.UML_TEST_CASE__NAME, oldName, name));
  }
  ...
  public Activity getActivityUnderTest()
  {
    if (activityUnderTest != null && activityUnderTest.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, TestLangPackage.UML_TEST_CASE__ACTIVITY_UNDER_TEST, oldActivityUnderTest, activityUnderTest));
      }
    }
  ...
  public void setActivityUnderTest(Activity newActivityUnderTest)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TestLangPackage.UML_TEST_CASE__ACTIVITY_UNDER_TEST, oldActivityUnderTest, activityUnderTest));
  }
  ...
  public EList<UMLActivityInput> getInputs()
  {
    if (inputs == null)
    {
      inputs = new EObjectContainmentEList<UMLActivityInput>(UMLActivityInput.class, this, TestLangPackage.UML_TEST_CASE__INPUTS);
    }
    return inputs;
  }
  ...
  public UMLObjectSpecification getContextObject()
  {
    if (contextObject != null && contextObject.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, TestLangPackage.UML_TEST_CASE__CONTEXT_OBJECT, oldContextObject, contextObject));
      }
    }
  ...
  public void setContextObject(UMLObjectSpecification newContextObject)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TestLangPackage.UML_TEST_CASE__CONTEXT_OBJECT, oldContextObject, contextObject));
  }
  ...
  public EList<UMLScenario> getInitScenarios()
  {
    ...
    {
      initScenarios = new EObjectResolvingEList<UMLScenario>(UMLScenario.class, this, TestLangPackage.UML_TEST_CASE__INIT_SCENARIOS);
    }
  ...
  public EList<UMLAssertion> getAssertions()
  {
    if (assertions == null)
    {
      assertions = new EObjectContainmentEList<UMLAssertion>(UMLAssertion.class, this, TestLangPackage.UML_TEST_CASE__ASSERTIONS);
    }
    return assertions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TestLangPackage.UML_TEST_CASE__INPUTS:
        return ((InternalEList<?>)getInputs()).basicRemove(otherEnd, msgs);
      case TestLangPackage.UML_TEST_CASE__ASSERTIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TestLangPackage.UML_TEST_CASE__NAME:
        return getName();
      case TestLangPackage.UML_TEST_CASE__ACTIVITY_UNDER_TEST:
        if (resolve) return getActivityUnderTest();
        return basicGetActivityUnderTest();
      case TestLangPackage.UML_TEST_CASE__INPUTS:
        return getInputs();
      case TestLangPackage.UML_TEST_CASE__CONTEXT_OBJECT:
        if (resolve) return getContextObject();
        return basicGetContextObject();
      case TestLangPackage.UML_TEST_CASE__INIT_SCENARIOS:
