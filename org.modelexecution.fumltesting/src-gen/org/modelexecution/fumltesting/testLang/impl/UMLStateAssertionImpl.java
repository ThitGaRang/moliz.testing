 ...
 * <ul>
 *   <li>{@link org.modelexecution.fumltesting.testLang.impl.UMLStateAssertionImpl#getQuantifier <em>Quantifier</em>}</li>
 *   <li>{@link org.modelexecution.fumltesting.testLang.impl.UMLStateAssertionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link org.modelexecution.fumltesting.testLang.impl.UMLStateAssertionImpl#getReferencePoint <em>Reference Point</em>}</li>
 *   <li>{@link org.modelexecution.fumltesting.testLang.impl.UMLStateAssertionImpl#getUntilPoint <em>Until Point</em>}</li>
 *   <li>{@link org.modelexecution.fumltesting.testLang.impl.UMLStateAssertionImpl#getChecks <em>Checks</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UMLStateAssertionImpl extends UMLAssertionImpl implements UMLStateAssertion
{
  ...
  {
    return TestLangPackage.Literals.UML_STATE_ASSERTION;
  }
  ...
  public void setQuantifier(UMLTemporalQuantifier newQuantifier)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TestLangPackage.UML_STATE_ASSERTION__QUANTIFIER, oldQuantifier, quantifier));
  }
  ...
  public void setOperator(UMLTemporalOperator newOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TestLangPackage.UML_STATE_ASSERTION__OPERATOR, oldOperator, operator));
  }
  ...
  public NotificationChain basicSetReferencePoint(UMLReferencePoint newReferencePoint, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TestLangPackage.UML_STATE_ASSERTION__REFERENCE_POINT, oldReferencePoint, newReferencePoint);
  ...
  public void setReferencePoint(UMLReferencePoint newReferencePoint)
  {
    if (newReferencePoint != referencePoint)
    {
      ...
      if (referencePoint != null)
        msgs = ((InternalEObject)referencePoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TestLangPackage.UML_STATE_ASSERTION__REFERENCE_POINT, null, msgs);
      if (newReferencePoint != null)
        msgs = ((InternalEObject)newReferencePoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TestLangPackage.UML_STATE_ASSERTION__REFERENCE_POINT, null, msgs);
      msgs = basicSetReferencePoint(newReferencePoint, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TestLangPackage.UML_STATE_ASSERTION__REFERENCE_POINT, newReferencePoint, newReferencePoint));
  }
  ...
  public NotificationChain basicSetUntilPoint(UMLReferencePoint newUntilPoint, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TestLangPackage.UML_STATE_ASSERTION__UNTIL_POINT, oldUntilPoint, newUntilPoint);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setUntilPoint(UMLReferencePoint newUntilPoint)
  {
    if (newUntilPoint != untilPoint)
    {
      NotificationChain msgs = null;
      if (untilPoint != null)
        msgs = ((InternalEObject)untilPoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TestLangPackage.UML_STATE_ASSERTION__UNTIL_POINT, null, msgs);
      if (newUntilPoint != null)
        msgs = ((InternalEObject)newUntilPoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TestLangPackage.UML_STATE_ASSERTION__UNTIL_POINT, null, msgs);
      msgs = basicSetUntilPoint(newUntilPoint, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TestLangPackage.UML_STATE_ASSERTION__UNTIL_POINT, newUntilPoint, newUntilPoint));
  }
  ...
  public EList<UMLCheck> getChecks()
  {
    if (checks == null)
    {
      checks = new EObjectContainmentEList<UMLCheck>(UMLCheck.class, this, TestLangPackage.UML_STATE_ASSERTION__CHECKS);
    }
    return checks;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TestLangPackage.UML_STATE_ASSERTION__REFERENCE_POINT:
        return basicSetReferencePoint(null, msgs);
      case TestLangPackage.UML_STATE_ASSERTION__UNTIL_POINT:
        return basicSetUntilPoint(null, msgs);
      case TestLangPackage.UML_STATE_ASSERTION__CHECKS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TestLangPackage.UML_STATE_ASSERTION__QUANTIFIER:
        return getQuantifier();
      case TestLangPackage.UML_STATE_ASSERTION__OPERATOR:
        return getOperator();
      case TestLangPackage.UML_STATE_ASSERTION__REFERENCE_POINT:
