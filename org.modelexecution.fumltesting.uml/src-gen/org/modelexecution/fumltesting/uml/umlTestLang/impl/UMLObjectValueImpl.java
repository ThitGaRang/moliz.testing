 ...
 * <ul>
 *   <li>{@link org.modelexecution.fumltesting.uml.umlTestLang.impl.UMLObjectValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UMLObjectValueImpl extends UMLValueImpl implements UMLObjectValue
{
  ...
  {
    return UmlTestLangPackage.Literals.UML_OBJECT_VALUE;
  }
    ...
    if (value != null && value.eIsProxy())
    {
      ...
      if (value != oldValue)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlTestLangPackage.UML_OBJECT_VALUE__VALUE, oldValue, value));
      }
    }
    return value;
  }
  ...
  public void setValue(UMLObjectSpecification newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmlTestLangPackage.UML_OBJECT_VALUE__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UmlTestLangPackage.UML_OBJECT_VALUE__VALUE:
