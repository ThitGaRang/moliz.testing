 ...
 * <ul>
 *   <li>{@link org.modelexecution.fumltesting.uml.umlTestLang.impl.UMLStateExpressionImpl#getPin <em>Pin</em>}</li>
 *   <li>{@link org.modelexecution.fumltesting.uml.umlTestLang.impl.UMLStateExpressionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link org.modelexecution.fumltesting.uml.umlTestLang.impl.UMLStateExpressionImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UMLStateExpressionImpl extends UMLCheckImpl implements UMLStateExpression
{
  ...
  {
    return UmlTestLangPackage.Literals.UML_STATE_EXPRESSION;
  }
    ...
    if (pin != null && pin.eIsProxy())
    {
      ...
      if (pin != oldPin)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlTestLangPackage.UML_STATE_EXPRESSION__PIN, oldPin, pin));
      }
    }
    return pin;
  }
  ...
  public void setPin(ObjectNode newPin)
  {
    ...
    pin = newPin;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmlTestLangPackage.UML_STATE_EXPRESSION__PIN, oldPin, pin));
  }
  ...
  public void setOperator(UMLArithmeticOperator newOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmlTestLangPackage.UML_STATE_EXPRESSION__OPERATOR, oldOperator, operator));
  }
  ...
  public NotificationChain basicSetValue(UMLValue newValue, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmlTestLangPackage.UML_STATE_EXPRESSION__VALUE, oldValue, newValue);
  ...
  public void setValue(UMLValue newValue)
  {
    if (newValue != value)
    {
      ...
      if (value != null)
        msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UmlTestLangPackage.UML_STATE_EXPRESSION__VALUE, null, msgs);
      if (newValue != null)
        msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UmlTestLangPackage.UML_STATE_EXPRESSION__VALUE, null, msgs);
      msgs = basicSetValue(newValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmlTestLangPackage.UML_STATE_EXPRESSION__VALUE, newValue, newValue));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UmlTestLangPackage.UML_STATE_EXPRESSION__VALUE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UmlTestLangPackage.UML_STATE_EXPRESSION__PIN:
        if (resolve) return getPin();
        return basicGetPin();
      case UmlTestLangPackage.UML_STATE_EXPRESSION__OPERATOR:
        return getOperator();
      case UmlTestLangPackage.UML_STATE_EXPRESSION__VALUE:
        return getValue();
    }
