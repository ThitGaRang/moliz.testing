 ...
 * <ul>
 *   <li>{@link org.modelexecution.fumltesting.uml.umlTestLang.impl.UMLLinkImpl#getAssoc <em>Assoc</em>}</li>
 *   <li>{@link org.modelexecution.fumltesting.uml.umlTestLang.impl.UMLLinkImpl#getSourceProperty <em>Source Property</em>}</li>
 *   <li>{@link org.modelexecution.fumltesting.uml.umlTestLang.impl.UMLLinkImpl#getSourceValue <em>Source Value</em>}</li>
 *   <li>{@link org.modelexecution.fumltesting.uml.umlTestLang.impl.UMLLinkImpl#getTargetProperty <em>Target Property</em>}</li>
 *   <li>{@link org.modelexecution.fumltesting.uml.umlTestLang.impl.UMLLinkImpl#getTargetValue <em>Target Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UMLLinkImpl extends MinimalEObjectImpl.Container implements UMLLink
{
  ...
  {
    return UmlTestLangPackage.Literals.UML_LINK;
  }
    ...
    if (assoc != null && assoc.eIsProxy())
    {
      ...
      if (assoc != oldAssoc)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlTestLangPackage.UML_LINK__ASSOC, oldAssoc, assoc));
      }
    }
    return assoc;
  }
  ...
  public void setAssoc(Association newAssoc)
  {
    ...
    assoc = newAssoc;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmlTestLangPackage.UML_LINK__ASSOC, oldAssoc, assoc));
  }
  ...
  public Property getSourceProperty()
  {
    if (sourceProperty != null && sourceProperty.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlTestLangPackage.UML_LINK__SOURCE_PROPERTY, oldSourceProperty, sourceProperty));
      }
    }
  ...
  public void setSourceProperty(Property newSourceProperty)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmlTestLangPackage.UML_LINK__SOURCE_PROPERTY, oldSourceProperty, sourceProperty));
  }
  ...
  public UMLObjectSpecification getSourceValue()
  {
    if (sourceValue != null && sourceValue.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlTestLangPackage.UML_LINK__SOURCE_VALUE, oldSourceValue, sourceValue));
      }
    }
    return sourceValue;
  }
  ...
  public void setSourceValue(UMLObjectSpecification newSourceValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmlTestLangPackage.UML_LINK__SOURCE_VALUE, oldSourceValue, sourceValue));
  }
  ...
  public Property getTargetProperty()
  {
    if (targetProperty != null && targetProperty.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlTestLangPackage.UML_LINK__TARGET_PROPERTY, oldTargetProperty, targetProperty));
      }
    }
  ...
  public void setTargetProperty(Property newTargetProperty)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmlTestLangPackage.UML_LINK__TARGET_PROPERTY, oldTargetProperty, targetProperty));
  }
  ...
  public UMLObjectSpecification getTargetValue()
  {
    if (targetValue != null && targetValue.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlTestLangPackage.UML_LINK__TARGET_VALUE, oldTargetValue, targetValue));
      }
    }
    return targetValue;
  }
  ...
  public void setTargetValue(UMLObjectSpecification newTargetValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmlTestLangPackage.UML_LINK__TARGET_VALUE, oldTargetValue, targetValue));
  }
