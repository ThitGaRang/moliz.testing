 ...
 * <ul>
 *   <li>{@link org.modelexecution.fumltesting.uml.umlTestLang.impl.FinallyStateAssertionImpl#getChecks <em>Checks</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FinallyStateAssertionImpl extends UMLFinallyStateAssertionImpl implements FinallyStateAssertion
{
  ...
  {
    return UmlTestLangPackage.Literals.FINALLY_STATE_ASSERTION;
  }
  ...
  public EList<UMLCheck> getChecks()
  {
    if (checks == null)
    {
      checks = new EObjectContainmentEList<UMLCheck>(UMLCheck.class, this, UmlTestLangPackage.FINALLY_STATE_ASSERTION__CHECKS);
    }
    return checks;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UmlTestLangPackage.FINALLY_STATE_ASSERTION__CHECKS:
