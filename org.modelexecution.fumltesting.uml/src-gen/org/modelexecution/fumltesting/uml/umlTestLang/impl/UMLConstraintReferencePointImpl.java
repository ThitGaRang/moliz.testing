 ...
 * <ul>
 *   <li>{@link org.modelexecution.fumltesting.uml.umlTestLang.impl.UMLConstraintReferencePointImpl#getConstraintName <em>Constraint Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UMLConstraintReferencePointImpl extends UMLReferencePointImpl implements UMLConstraintReferencePoint
{
  ...
  {
    return UmlTestLangPackage.Literals.UML_CONSTRAINT_REFERENCE_POINT;
  }
  ...
  public NotificationChain basicSetConstraintName(XExpression newConstraintName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmlTestLangPackage.UML_CONSTRAINT_REFERENCE_POINT__CONSTRAINT_NAME, oldConstraintName, newConstraintName);
  ...
  public void setConstraintName(XExpression newConstraintName)
  {
    if (newConstraintName != constraintName)
    {
      ...
      if (constraintName != null)
        msgs = ((InternalEObject)constraintName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UmlTestLangPackage.UML_CONSTRAINT_REFERENCE_POINT__CONSTRAINT_NAME, null, msgs);
      if (newConstraintName != null)
        msgs = ((InternalEObject)newConstraintName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UmlTestLangPackage.UML_CONSTRAINT_REFERENCE_POINT__CONSTRAINT_NAME, null, msgs);
      msgs = basicSetConstraintName(newConstraintName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmlTestLangPackage.UML_CONSTRAINT_REFERENCE_POINT__CONSTRAINT_NAME, newConstraintName, newConstraintName));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UmlTestLangPackage.UML_CONSTRAINT_REFERENCE_POINT__CONSTRAINT_NAME:
