...
/**
 * Manual modifications go to {org.modelexecution.fumltesting.uml.UmlTestLangRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractUmlTestLangRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/modelexecution/fumltesting/uml/UmlTestLang.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.modelexecution.fumltesting.uml.UmlTestLang");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("umltest");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.modelexecution.fumltesting.uml.services.UmlTestLangGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return org.modelexecution.fumltesting.uml.serializer.UmlTestLangSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return org.modelexecution.fumltesting.uml.serializer.UmlTestLangSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.modelexecution.fumltesting.uml.parser.antlr.UmlTestLangParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.modelexecution.fumltesting.uml.parser.antlr.UmlTestLangAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.modelexecution.fumltesting.uml.parser.antlr.internal.InternalUmlTestLangLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.modelexecution.fumltesting.uml.parser.antlr.internal.InternalUmlTestLangLexer> provideInternalUmlTestLangLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.modelexecution.fumltesting.uml.parser.antlr.internal.InternalUmlTestLangLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.modelexecution.fumltesting.uml.parser.antlr.internal.InternalUmlTestLangLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends org.modelexecution.fumltesting.uml.validation.UmlTestLangJavaValidator> bindUmlTestLangJavaValidator() {
		return org.modelexecution.fumltesting.uml.validation.UmlTestLangJavaValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return org.modelexecution.fumltesting.uml.formatting.UmlTestLangFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return org.modelexecution.fumltesting.uml.jvmmodel.UmlTestLangJvmModelInferrer.class;
	}
