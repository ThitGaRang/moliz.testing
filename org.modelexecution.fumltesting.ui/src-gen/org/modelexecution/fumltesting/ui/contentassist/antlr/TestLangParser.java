		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getOOStateAssertionAccess().getGroup(), "rule__OOStateAssertion__Group__0");
					put(grammarAccess.getOOStateAssertionAccess().getGroup_0(), "rule__OOStateAssertion__Group_0__0");
					put(grammarAccess.getOOStateAssertionAccess().getGroup_2(), "rule__OOStateAssertion__Group_2__0");
					put(grammarAccess.getOOGlobalStateAssertionAccess().getGroup(), "rule__OOGlobalStateAssertion__Group__0");
					put(grammarAccess.getOOGlobalStateAssertionAccess().getGroup_0(), "rule__OOGlobalStateAssertion__Group_0__0");
					put(grammarAccess.getOOGlobalStateAssertionAccess().getGroup_3(), "rule__OOGlobalStateAssertion__Group_3__0");
					put(grammarAccess.getFinallyStateAssertionAccess().getGroup(), "rule__FinallyStateAssertion__Group__0");
					put(grammarAccess.getConstraintCheckAccess().getGroup(), "rule__ConstraintCheck__Group__0");
					put(grammarAccess.getConstraintCheckAccess().getGroup_2(), "rule__ConstraintCheck__Group_2__0");
					put(grammarAccess.getConstraintCheckAccess().getGroup_3(), "rule__ConstraintCheck__Group_3__0");
					...
					put(grammarAccess.getStateAssertionAccess().getConstraintCheckAssignment_4(), "rule__StateAssertion__ConstraintCheckAssignment_4");
					put(grammarAccess.getStateAssertionAccess().getExpressionsAssignment_5(), "rule__StateAssertion__ExpressionsAssignment_5");
					put(grammarAccess.getOOStateAssertionAccess().getTemporalQuantifierAssignment_0_1(), "rule__OOStateAssertion__TemporalQuantifierAssignment_0_1");
					put(grammarAccess.getOOStateAssertionAccess().getTemporalOperatorAssignment_0_2(), "rule__OOStateAssertion__TemporalOperatorAssignment_0_2");
					put(grammarAccess.getOOStateAssertionAccess().getReferenceConstraintAssignment_1(), "rule__OOStateAssertion__ReferenceConstraintAssignment_1");
					put(grammarAccess.getOOStateAssertionAccess().getUntilConstraintAssignment_2_1(), "rule__OOStateAssertion__UntilConstraintAssignment_2_1");
					put(grammarAccess.getOOStateAssertionAccess().getConstraintCheckAssignment_4(), "rule__OOStateAssertion__ConstraintCheckAssignment_4");
					put(grammarAccess.getOOStateAssertionAccess().getExpressionsAssignment_5(), "rule__OOStateAssertion__ExpressionsAssignment_5");
					put(grammarAccess.getOOGlobalStateAssertionAccess().getConditionConstraintAssignment_0_1(), "rule__OOGlobalStateAssertion__ConditionConstraintAssignment_0_1");
					put(grammarAccess.getOOGlobalStateAssertionAccess().getQuantifierAssignment_1(), "rule__OOGlobalStateAssertion__QuantifierAssignment_1");
					put(grammarAccess.getOOGlobalStateAssertionAccess().getEvaluatedConstraintAssignment_2(), "rule__OOGlobalStateAssertion__EvaluatedConstraintAssignment_2");
					put(grammarAccess.getOOGlobalStateAssertionAccess().getObjectAssignment_3_1(), "rule__OOGlobalStateAssertion__ObjectAssignment_3_1");
					put(grammarAccess.getFinallyStateAssertionAccess().getConstraintCheckAssignment_3(), "rule__FinallyStateAssertion__ConstraintCheckAssignment_3");
					put(grammarAccess.getFinallyStateAssertionAccess().getExpressionsAssignment_4(), "rule__FinallyStateAssertion__ExpressionsAssignment_4");
					put(grammarAccess.getConstraintCheckAccess().getConstraintNamesAssignment_1(), "rule__ConstraintCheck__ConstraintNamesAssignment_1");
					put(grammarAccess.getConstraintCheckAccess().getConstraintNamesAssignment_2_1(), "rule__ConstraintCheck__ConstraintNamesAssignment_2_1");
					put(grammarAccess.getConstraintCheckAccess().getObjectAssignment_3_1(), "rule__ConstraintCheck__ObjectAssignment_3_1");
