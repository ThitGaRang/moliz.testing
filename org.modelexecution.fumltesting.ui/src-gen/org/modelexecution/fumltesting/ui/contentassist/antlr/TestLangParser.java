		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStateAssertionAccess().getConstraintsAssignment_4(), "rule__StateAssertion__ConstraintsAssignment_4");
					put(grammarAccess.getStateAssertionAccess().getExpressionsAssignment_5(), "rule__StateAssertion__ExpressionsAssignment_5");
					put(grammarAccess.getFinallyStateAssertionAccess().getConstraintsAssignment_3(), "rule__FinallyStateAssertion__ConstraintsAssignment_3");
					...
					put(grammarAccess.getConstraintAccess().getSpecificationAssignment_1(), "rule__Constraint__SpecificationAssignment_1");
