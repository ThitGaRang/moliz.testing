		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getReferencePointAccess().getAlternatives(), "rule__ReferencePoint__Alternatives");
					...
					put(grammarAccess.getActionReferencePointAccess().getGroup(), "rule__ActionReferencePoint__Group__0");
					put(grammarAccess.getConstraintReferencePointAccess().getGroup(), "rule__ConstraintReferencePoint__Group__0");
					...
					put(grammarAccess.getStateAssertionAccess().getQuantifierAssignment_1(), "rule__StateAssertion__QuantifierAssignment_1");
					put(grammarAccess.getStateAssertionAccess().getOperatorAssignment_2(), "rule__StateAssertion__OperatorAssignment_2");
					put(grammarAccess.getStateAssertionAccess().getReferencePointAssignment_3(), "rule__StateAssertion__ReferencePointAssignment_3");
					put(grammarAccess.getStateAssertionAccess().getUntilPointAssignment_4_1(), "rule__StateAssertion__UntilPointAssignment_4_1");
					put(grammarAccess.getStateAssertionAccess().getChecksAssignment_6(), "rule__StateAssertion__ChecksAssignment_6");
					put(grammarAccess.getActionReferencePointAccess().getActionAssignment_1(), "rule__ActionReferencePoint__ActionAssignment_1");
					put(grammarAccess.getConstraintReferencePointAccess().getConstraintNameAssignment_1(), "rule__ConstraintReferencePoint__ConstraintNameAssignment_1");
					put(grammarAccess.getFinallyStateAssertionAccess().getChecksAssignment_3(), "rule__FinallyStateAssertion__ChecksAssignment_3");
