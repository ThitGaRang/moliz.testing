		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFinallyStateAssertionAccess().getGroup_3(), "rule__FinallyStateAssertion__Group_3__0");
					put(grammarAccess.getConstraintsAccess().getGroup(), "rule__Constraints__Group__0");
					put(grammarAccess.getConstraintsAccess().getGroup_1(), "rule__Constraints__Group_1__0");
					...
					put(grammarAccess.getStateAssertionAccess().getConstraintsAssignment_4_1(), "rule__StateAssertion__ConstraintsAssignment_4_1");
					put(grammarAccess.getStateAssertionAccess().getExpressionsAssignment_5(), "rule__StateAssertion__ExpressionsAssignment_5");
					put(grammarAccess.getFinallyStateAssertionAccess().getConstraintsAssignment_3_1(), "rule__FinallyStateAssertion__ConstraintsAssignment_3_1");
					...
					put(grammarAccess.getConstraintsAccess().getNamesAssignment_0(), "rule__Constraints__NamesAssignment_0");
					put(grammarAccess.getConstraintsAccess().getNamesAssignment_1_1(), "rule__Constraints__NamesAssignment_1_1");
