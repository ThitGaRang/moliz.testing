 ...
 * 
 */
public abstract class SnapshotUtil {

	protected ArrayList<ValueSnapshot> predecessorSnapshots;
	protected ArrayList<ValueSnapshot> successorSnapshots;

	protected ValueInstance valueInstance;
	protected ActivityNodeExecution referenceActionExecution;
	protected ActivityNodeExecution untilActionExecution;
	...
	public abstract ArrayList<ValueSnapshot> getRelevantSnapshots(Object expression, ActivityNodeExecution referenceActionExecution,
			ActivityNodeExecution untilActionExecution);
	
	protected void initializePredecessorSnapshots(ActivityNodeExecution nodeExecution) {
	...
	protected void initializeSuccessorSnapshots(ActivityNodeExecution nodeExecution) {
	...
	protected void setupPredecessors(String operator, ActionExecution nodeExecution) {
		for (Input input : nodeExecution.getInputs()) {
			...
			if (referredValueInstance == valueInstance && operator.equalsIgnoreCase("until")) {
	...
	protected void setupSucessors(String operator, ActionExecution nodeExecution) {
		for (Output output : nodeExecution.getOutputs()) {
			...
			if (referredValueInstance == valueInstance && operator.equalsIgnoreCase("after"))
