...
* generated by Xtext
*/
package org.modelexecution.fumltesting.uml.ui.contentassist.antlr;
...
public class UmlTestLangParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.modelexecution.fumltesting.uml.ui.contentassist.antlr.internal.InternalUmlTestLangParser createParser() {
		org.modelexecution.fumltesting.uml.ui.contentassist.antlr.internal.InternalUmlTestLangParser result = new org.modelexecution.fumltesting.uml.ui.contentassist.antlr.internal.InternalUmlTestLangParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getUMLValueAccess().getAlternatives(), "rule__UMLValue__Alternatives");
					put(grammarAccess.getUMLAssertionAccess().getAlternatives(), "rule__UMLAssertion__Alternatives");
					put(grammarAccess.getUMLReferencePointAccess().getAlternatives(), "rule__UMLReferencePoint__Alternatives");
					put(grammarAccess.getUMLCheckAccess().getAlternatives(), "rule__UMLCheck__Alternatives");
					put(grammarAccess.getUMLStateExpressionAccess().getAlternatives(), "rule__UMLStateExpression__Alternatives");
					put(grammarAccess.getUMLNodeSpecificationAccess().getAlternatives(), "rule__UMLNodeSpecification__Alternatives");
					...
					put(grammarAccess.getUMLArithmeticOperatorAccess().getAlternatives(), "rule__UMLArithmeticOperator__Alternatives");
					put(grammarAccess.getUMLTemporalOperatorAccess().getAlternatives(), "rule__UMLTemporalOperator__Alternatives");
					put(grammarAccess.getUMLTemporalQuantifierAccess().getAlternatives(), "rule__UMLTemporalQuantifier__Alternatives");
					put(grammarAccess.getUMLTestSuiteAccess().getGroup(), "rule__UMLTestSuite__Group__0");
					put(grammarAccess.getImportAccess().getGroup(), "rule__Import__Group__0");
					put(grammarAccess.getUMLTestCaseAccess().getGroup(), "rule__UMLTestCase__Group__0");
					put(grammarAccess.getUMLTestCaseAccess().getGroup_4(), "rule__UMLTestCase__Group_4__0");
					...
					put(grammarAccess.getUMLTestCaseAccess().getGroup_7_2(), "rule__UMLTestCase__Group_7_2__0");
					...
					put(grammarAccess.getUMLLinkAccess().getGroup(), "rule__UMLLink__Group__0");
					put(grammarAccess.getUMLStateAssertionAccess().getGroup(), "rule__UMLStateAssertion__Group__0");
					put(grammarAccess.getUMLStateAssertionAccess().getGroup_4(), "rule__UMLStateAssertion__Group_4__0");
					put(grammarAccess.getUMLActionReferencePointAccess().getGroup(), "rule__UMLActionReferencePoint__Group__0");
					put(grammarAccess.getUMLConstraintReferencePointAccess().getGroup(), "rule__UMLConstraintReferencePoint__Group__0");
					put(grammarAccess.getUMLFinallyStateAssertionAccess().getGroup(), "rule__UMLFinallyStateAssertion__Group__0");
					put(grammarAccess.getUMLConstraintCheckAccess().getGroup(), "rule__UMLConstraintCheck__Group__0");
					put(grammarAccess.getUMLConstraintCheckAccess().getGroup_2(), "rule__UMLConstraintCheck__Group_2__0");
					put(grammarAccess.getUMLConstraintCheckAccess().getGroup_3(), "rule__UMLConstraintCheck__Group_3__0");
					put(grammarAccess.getUMLObjectStateExpressionAccess().getGroup(), "rule__UMLObjectStateExpression__Group__0");
					put(grammarAccess.getUMLPropertyStateExpressionAccess().getGroup(), "rule__UMLPropertyStateExpression__Group__0");
					put(grammarAccess.getUMLOrderAssertionAccess().getGroup(), "rule__UMLOrderAssertion__Group__0");
					put(grammarAccess.getUMLNodeOrderAccess().getGroup(), "rule__UMLNodeOrder__Group__0");
					put(grammarAccess.getUMLNodeOrderAccess().getGroup_1(), "rule__UMLNodeOrder__Group_1__0");
					put(grammarAccess.getUMLNodeSpecificationAccess().getGroup_0(), "rule__UMLNodeSpecification__Group_0__0");
					put(grammarAccess.getUMLNodeSpecificationAccess().getGroup_0_1(), "rule__UMLNodeSpecification__Group_0_1__0");
					put(grammarAccess.getUMLNodeSpecificationAccess().getGroup_0_2(), "rule__UMLNodeSpecification__Group_0_2__0");
					...
					put(grammarAccess.getUMLTestCaseAccess().getActivityUnderTestAssignment_3(), "rule__UMLTestCase__ActivityUnderTestAssignment_3");
					...
					put(grammarAccess.getUMLTestCaseAccess().getInitScenariosAssignment_7_1(), "rule__UMLTestCase__InitScenariosAssignment_7_1");
					put(grammarAccess.getUMLTestCaseAccess().getInitScenariosAssignment_7_2_1(), "rule__UMLTestCase__InitScenariosAssignment_7_2_1");
					...
					put(grammarAccess.getUMLScenarioAccess().getLinksAssignment_4(), "rule__UMLScenario__LinksAssignment_4");
					put(grammarAccess.getUMLObjectSpecificationAccess().getNameAssignment_1(), "rule__UMLObjectSpecification__NameAssignment_1");
					put(grammarAccess.getUMLObjectSpecificationAccess().getTypeAssignment_3(), "rule__UMLObjectSpecification__TypeAssignment_3");
					put(grammarAccess.getUMLObjectSpecificationAccess().getAttributesAssignment_5(), "rule__UMLObjectSpecification__AttributesAssignment_5");
					put(grammarAccess.getUMLAttributeAccess().getAttAssignment_0(), "rule__UMLAttribute__AttAssignment_0");
					put(grammarAccess.getUMLAttributeAccess().getValueAssignment_2(), "rule__UMLAttribute__ValueAssignment_2");
					put(grammarAccess.getUMLLinkAccess().getAssocAssignment_1(), "rule__UMLLink__AssocAssignment_1");
					put(grammarAccess.getUMLLinkAccess().getSourcePropertyAssignment_4(), "rule__UMLLink__SourcePropertyAssignment_4");
					put(grammarAccess.getUMLLinkAccess().getSourceValueAssignment_6(), "rule__UMLLink__SourceValueAssignment_6");
					put(grammarAccess.getUMLLinkAccess().getTargetPropertyAssignment_9(), "rule__UMLLink__TargetPropertyAssignment_9");
					put(grammarAccess.getUMLLinkAccess().getTargetValueAssignment_11(), "rule__UMLLink__TargetValueAssignment_11");
					put(grammarAccess.getUMLStateAssertionAccess().getQuantifierAssignment_1(), "rule__UMLStateAssertion__QuantifierAssignment_1");
					put(grammarAccess.getUMLStateAssertionAccess().getOperatorAssignment_2(), "rule__UMLStateAssertion__OperatorAssignment_2");
					put(grammarAccess.getUMLStateAssertionAccess().getReferencePointAssignment_3(), "rule__UMLStateAssertion__ReferencePointAssignment_3");
					put(grammarAccess.getUMLStateAssertionAccess().getUntilPointAssignment_4_1(), "rule__UMLStateAssertion__UntilPointAssignment_4_1");
					put(grammarAccess.getUMLStateAssertionAccess().getChecksAssignment_6(), "rule__UMLStateAssertion__ChecksAssignment_6");
					put(grammarAccess.getUMLActionReferencePointAccess().getActionAssignment_1(), "rule__UMLActionReferencePoint__ActionAssignment_1");
					put(grammarAccess.getUMLConstraintReferencePointAccess().getConstraintNameAssignment_1(), "rule__UMLConstraintReferencePoint__ConstraintNameAssignment_1");
					put(grammarAccess.getUMLFinallyStateAssertionAccess().getChecksAssignment_3(), "rule__UMLFinallyStateAssertion__ChecksAssignment_3");
					put(grammarAccess.getUMLConstraintCheckAccess().getConstraintNamesAssignment_1(), "rule__UMLConstraintCheck__ConstraintNamesAssignment_1");
					put(grammarAccess.getUMLConstraintCheckAccess().getConstraintNamesAssignment_2_1(), "rule__UMLConstraintCheck__ConstraintNamesAssignment_2_1");
					put(grammarAccess.getUMLConstraintCheckAccess().getObjectAssignment_3_1(), "rule__UMLConstraintCheck__ObjectAssignment_3_1");
					put(grammarAccess.getUMLObjectStateExpressionAccess().getPinAssignment_0(), "rule__UMLObjectStateExpression__PinAssignment_0");
					put(grammarAccess.getUMLObjectStateExpressionAccess().getOperatorAssignment_1(), "rule__UMLObjectStateExpression__OperatorAssignment_1");
					put(grammarAccess.getUMLObjectStateExpressionAccess().getValueAssignment_2(), "rule__UMLObjectStateExpression__ValueAssignment_2");
					put(grammarAccess.getUMLPropertyStateExpressionAccess().getPinAssignment_0(), "rule__UMLPropertyStateExpression__PinAssignment_0");
					put(grammarAccess.getUMLPropertyStateExpressionAccess().getPropertyAssignment_2(), "rule__UMLPropertyStateExpression__PropertyAssignment_2");
					put(grammarAccess.getUMLPropertyStateExpressionAccess().getOperatorAssignment_3(), "rule__UMLPropertyStateExpression__OperatorAssignment_3");
					put(grammarAccess.getUMLPropertyStateExpressionAccess().getValueAssignment_4(), "rule__UMLPropertyStateExpression__ValueAssignment_4");
					put(grammarAccess.getUMLOrderAssertionAccess().getOrderAssignment_1(), "rule__UMLOrderAssertion__OrderAssignment_1");
					put(grammarAccess.getUMLNodeOrderAccess().getNodesAssignment_0(), "rule__UMLNodeOrder__NodesAssignment_0");
					put(grammarAccess.getUMLNodeOrderAccess().getNodesAssignment_1_1(), "rule__UMLNodeOrder__NodesAssignment_1_1");
					put(grammarAccess.getUMLNodeSpecificationAccess().getNodeAssignment_0_0(), "rule__UMLNodeSpecification__NodeAssignment_0_0");
					put(grammarAccess.getUMLNodeSpecificationAccess().getSizeAssignment_0_1_1(), "rule__UMLNodeSpecification__SizeAssignment_0_1_1");
					put(grammarAccess.getUMLNodeSpecificationAccess().getSubOrderAssignment_0_2_1(), "rule__UMLNodeSpecification__SubOrderAssignment_0_2_1");
					put(grammarAccess.getUMLNodeSpecificationAccess().getJokerAssignment_1(), "rule__UMLNodeSpecification__JokerAssignment_1");
					put(grammarAccess.getUMLNodeSpecificationAccess().getJokerAssignment_2(), "rule__UMLNodeSpecification__JokerAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.modelexecution.fumltesting.uml.ui.contentassist.antlr.internal.InternalUmlTestLangParser typedParser = (org.modelexecution.fumltesting.uml.ui.contentassist.antlr.internal.InternalUmlTestLangParser) parser;
			typedParser.entryRuleUMLTestSuite();
