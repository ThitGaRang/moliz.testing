...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>XMOF Arithmetic Operator</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.modelexecution.fumltesting.xmof.xmofTestLang.XmofTestLangPackage#getXMOFArithmeticOperator()
 * @model
 * @generated
 */
public enum XMOFArithmeticOperator implements Enumerator
{
  /**
  ...
  /**
   * An array of all the '<em><b>XMOF Arithmetic Operator</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private static final XMOFArithmeticOperator[] VALUES_ARRAY =
    new XMOFArithmeticOperator[]
    {
      EQUAL,
      NOT_EQUAL,
      GREATER,
  ...
  /**
   * A public read-only list of all the '<em><b>XMOF Arithmetic Operator</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final List<XMOFArithmeticOperator> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>XMOF Arithmetic Operator</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static XMOFArithmeticOperator get(String literal)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      XMOFArithmeticOperator result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>XMOF Arithmetic Operator</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static XMOFArithmeticOperator getByName(String name)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      XMOFArithmeticOperator result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>XMOF Arithmetic Operator</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static XMOFArithmeticOperator get(int value)
  {
    switch (value)
    {
   ...
   * @generated
   */
  private XMOFArithmeticOperator(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
