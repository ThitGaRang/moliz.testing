...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>XMOF Temporal Quantifier</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.modelexecution.fumltesting.xmof.xmofTestLang.XmofTestLangPackage#getXMOFTemporalQuantifier()
 * @model
 * @generated
 */
public enum XMOFTemporalQuantifier implements Enumerator
{
  /**
  ...
  /**
   * An array of all the '<em><b>XMOF Temporal Quantifier</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private static final XMOFTemporalQuantifier[] VALUES_ARRAY =
    new XMOFTemporalQuantifier[]
    {
      ALWAYS,
      SOMETIMES,
      EVENTUALLY,
  ...
  /**
   * A public read-only list of all the '<em><b>XMOF Temporal Quantifier</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final List<XMOFTemporalQuantifier> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>XMOF Temporal Quantifier</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static XMOFTemporalQuantifier get(String literal)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      XMOFTemporalQuantifier result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>XMOF Temporal Quantifier</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static XMOFTemporalQuantifier getByName(String name)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      XMOFTemporalQuantifier result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>XMOF Temporal Quantifier</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static XMOFTemporalQuantifier get(int value)
  {
    switch (value)
    {
   ...
   * @generated
   */
  private XMOFTemporalQuantifier(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
