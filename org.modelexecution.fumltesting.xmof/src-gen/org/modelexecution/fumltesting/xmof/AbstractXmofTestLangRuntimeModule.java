...
/**
 * Manual modifications go to {org.modelexecution.fumltesting.xmof.XmofTestLangRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractXmofTestLangRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/modelexecution/fumltesting/xmof/XmofTestLang.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.modelexecution.fumltesting.xmof.XmofTestLang");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("xmoftest");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.modelexecution.fumltesting.xmof.services.XmofTestLangGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return org.modelexecution.fumltesting.xmof.serializer.XmofTestLangSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return org.modelexecution.fumltesting.xmof.serializer.XmofTestLangSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.modelexecution.fumltesting.xmof.parser.antlr.XmofTestLangParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.modelexecution.fumltesting.xmof.parser.antlr.XmofTestLangAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.modelexecution.fumltesting.xmof.parser.antlr.internal.InternalXmofTestLangLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.modelexecution.fumltesting.xmof.parser.antlr.internal.InternalXmofTestLangLexer> provideInternalXmofTestLangLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.modelexecution.fumltesting.xmof.parser.antlr.internal.InternalXmofTestLangLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.modelexecution.fumltesting.xmof.parser.antlr.internal.InternalXmofTestLangLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends org.modelexecution.fumltesting.xmof.validation.XmofTestLangValidator> bindXmofTestLangValidator() {
		return org.modelexecution.fumltesting.xmof.validation.XmofTestLangValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return org.modelexecution.fumltesting.xmof.formatting.XmofTestLangFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return org.modelexecution.fumltesting.xmof.jvmmodel.XmofTestLangJvmModelInferrer.class;
	}
