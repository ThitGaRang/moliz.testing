...
public class XmofTestLangSyntacticSequencer extends AbstractSyntacticSequencer {

	protected XmofTestLangGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (XmofTestLangGrammarAccess) access;
